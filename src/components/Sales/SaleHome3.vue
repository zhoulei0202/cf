<template>
  <div>
    ...
    <el-row class="height2" :gutter="10">
      <el-col :span="6">
        <div>
          <ul class="sale-ul">
            <li>销售总金额(百万元)</li>
          ...
          <div style="display:inline-block;margin-left:20px;">
            <el-progress type="circle" :percentage="60" :width="60"></el-progress>
          </div>
        </div>
      </el-col>
      <el-col :span="6">
        <div>
          ...
          <div style="display:inline-block;margin-left:20px;">
            <el-progress type="circle" :percentage="40" :width="60"></el-progress>
          </div>
        </div>
      </el-col>
      <el-col :span="6">
    ...
    <el-row class="height3" :gutter="10">
      <el-col :span="6">
